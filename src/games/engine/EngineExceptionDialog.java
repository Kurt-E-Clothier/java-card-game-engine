/***********************************************************************//**
 * @file		EngineExceptionDialog.java
 * @author		Kurt E. Clothier
 * @date		December 9, 2015
 * 
 * @breif		Custom dialog box for displaying Engine Exceptions
 * 
...
public final class EngineExceptionDialog implements Displayable{
	...
	private final EngineException e;
	
	/**
	 * Construct a <tt>EngineExceptionDialog</tt> using the specified <tt>EngineException</tt>.
	 * 
	 * @param e a <tt>EngineException</tt> to be used in this dialog.
	 */
	public EngineExceptionDialog(final EngineException e) {
		this.e = e;
	}
	
	/**
	 * Display this <tt>EngineExceptionDialog</tt>.
	 * 
	 * Terminates the running application when closed.
	 */
	@Override public void display() {
		JOptionPane.showMessageDialog(null, createDisplayPanel(e), "Engine Exception", JOptionPane.ERROR_MESSAGE);
		System.exit(0);
	}
	
	/** This dialog cannot be hidden */
	@Override public void hide() {}
	
	/* Create and return a JPanel for this exception dialog */
	private static JPanel createDisplayPanel(final EngineException e) {
		final JPanel panel = new JPanel();
		panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
		createAndAddHeader(panel, "A fatal Engine Exception has occured!   ");
		createAndAddLabel(panel, "Type: " + e.getType().toString());
		createAndAddLabel(panel, "Description: " + e.getDescription());
	...
	private static void createAndAddStackTrace(final Container con, final EngineException e) {
