/***********************************************************************//**
 * @file		PluginExceptionDialog.java
 * @author		Kurt E. Clothier
 * @date		December 9, 2015
 * 
 * @breif		Custom dialog box for displaying Plugin Exceptions
 * 
...
public final class PluginExceptionDialog implements Displayable{
	...
	private final PluginException e;
	
	/**
	 * Construct a <tt>PluginExceptionDialog</tt> using the specified <tt>PluginException</tt>.
	 * 
	 * @param e a <tt>PluginException</tt> to be used in this dialog.
	 */
	public PluginExceptionDialog(final PluginException e) {
		this.e = e;
	}
	
	/**
	 * Display this <tt>PluginExceptionDialog</tt>.
	 * Terminates the running application when closed.
	 */
	@Override public void display() {
		JOptionPane.showMessageDialog(null, createDisplayPanel(e), "Plugin Exception", JOptionPane.ERROR_MESSAGE);
		System.exit(0);
	}
	...
	private static JPanel createDisplayPanel(final PluginException e) {
		final JPanel panel = new JPanel();
		panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
		createAndAddHeader(panel, "A fatal Plugin Exception has occured!   ");
	...
	private static void createAndAddStackTrace(final Container con, final PluginException e) {
